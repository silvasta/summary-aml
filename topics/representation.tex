...
% TODO: merge all losses from all chapters
...
\\
\textbf{Trick}
CRLB achieved iff estimator is efficient (e.g., MLE in
exponential families)
Multivariate: Use inverse Fisher matrix.
\\
Hint for exams: Always check unbiasedness first; compute via Hessian or
score function.

\subsection{Formulas: Fisher Information}

Param sensitivity in likelihood. $I(\theta) =
...
where $s(X)$ is sufficient statistic
(e.g., in Gaussians, sample mean givs CRLB)
